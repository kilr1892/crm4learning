 ...
 * @version v1.0
 */
public class ExcelInputBean2 extends BaseRowModel {

    /** 订单生成日期 */
    @ExcelProperty(index = 1, value = "日期", format = "yyyy/MM/dd")
    ...
    /** 材料名称 */
    @ExcelProperty(index = 3, value = "材料名称")
    ...
    /** 重量 */
    @ExcelProperty(index = 7, value = "重量")
    private String orderMaterialWeight;

    /** 单价 */
    @ExcelProperty(index = 8, value = "单价")
    private String orderPrice;

    /** 销售金额 */
    @ExcelProperty(index = 9, value = "销售金额")
    private String orderTotalPrice;

    /** 切割工 */
    @ExcelProperty(index = 10, value = "切割工")
    private String orderCuttingWage;

    /** 税点 */
    @ExcelProperty(index = 11, value = "税点")
    private String orderTaxPoint;

    /** 冲帐 */
    @ExcelProperty(index = 12, value = "冲帐")
    private String orderStrike;

    /** 进项金额 */
    @ExcelProperty(index = 13, value = "进项金额")
    private String paymentInputMoney;

    /** 应收款 */
    @ExcelProperty(index = 14, value = "应收款")
    private String showEveryReceivables;

    /** 收款方式 */
    @ExcelProperty(index = 15, value = "收款方式")
